@echo off
title Vampir Koylu API - GUNCELLEME v0.2.7
cd /d "%~dp0"
...
echo.
echo Test:
echo http://85.95.251.204:3000/api/version?clientVersion=0.2.6^&platform=android
echo Beklenen: needsUpdate true, latestVersion 0.2.7
echo.
node src\index.js

...
echo.
echo === Vampir Koylu API v0.2.6 ===
set PORT=3000
set NODE_ENV=production
set MIN_REQUIRED_VERSION=0.2.5
set LATEST_VERSION=0.2.6
set FORCE_UPDATE=true
set UPDATE_URL_ANDROID=https://github.com/afmolla/flutter/releases/download/v0.2.6/app-release.apk

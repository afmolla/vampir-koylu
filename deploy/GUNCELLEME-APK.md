...
Kullanılabilir APK: **v0.2.8** → https://github.com/afmolla/vampir-koylu/releases/download/v0.2.8/app-release.apk

## v0.2.10 (sabit imza)

1. `main` + tag `v0.2.10` — Actions **Android APK Release**
2. Yeşil olunca: https://github.com/afmolla/vampir-koylu/releases/download/v0.2.10/app-release.apk
